...
#[test]
fn release_target_check_allows_only_v0_4_16() -> Result<(), Box<dyn std::error::Error>> {
    let root = workspace_root()?;
    assert!(release_target_check(root, "0.4.16")?);
    for version in [
        "0.3.9", "0.4.0", "0.4.1", "0.4.2", "0.4.3", "0.4.4", "0.4.5", "0.4.6", "0.4.7", "0.4.8",
        "0.4.9", "0.4.10", "0.4.11", "0.4.12", "0.4.13", "0.4.14", "0.4.15", "0.5.0", "1.0.0",
        "2.0.0",
    ] {
